namespace CrossCoreExtIdApi.Services
{
    ...
    public class CrossCoreService : IService
    {
        ...
        public async Task<string> ServiceCall(ICrossCoreInput input)
        {
            ...
            return ccResponse.ResponseHeader.OverallResponse.Decision;
        }
        ...
        private CrossCoreRequest SetupRequest(ICrossCoreInput input)
        {
            ...
            request.Header.RequestType = config.HdrRequestType;
